...
[![Build Status](https://travis-ci.org/nithishmarneni/financial-java-api.svg?branch=master)](https://travis-ci.org/nithishmarneni/financial-java-api) ![GitHub forks](https://img.shields.io/github/forks/nithishmarneni/financial-java-api?style=social) ![GitHub release (latest by date)](https://img.shields.io/github/v/release/nithishmarneni/financial-java-api) ![GitHub language count](https://img.shields.io/github/languages/count/nithishmarneni/financial-java-api) ![GitHub code size in bytes](https://img.shields.io/github/languages/code-size/nithishmarneni/financial-java-api) ![GitHub repo size](https://img.shields.io/github/repo-size/nithishmarneni/financial-java-api) ![GitHub last commit](https://img.shields.io/github/last-commit/nithishmarneni/financial-java-api) ![GitHub](https://img.shields.io/github/license/nithishmarneni/financial-java-api)
...
These articles provide additional context and were originally authored by Maria Azevedo:
...
This project is currently maintained by Nithish Marneni, a Software Developer with 3+ years of professional experience in Java, JavaScript, TypeScript, SQL, Spring Boot, Spring Security, and Hibernate.

Feel free to connect or reach out:
*   GitHub: [https://github.com/nithishmarneni](https://github.com/nithishmarneni)
*   LinkedIn: [https://www.linkedin.com/in/nithish-marneni/](https://www.linkedin.com/in/nithish-marneni/)
